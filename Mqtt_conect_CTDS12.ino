...
const char* IP_do_servidor = "10.140.4.49"; // IP do broker MQTT
...
Serial.println(minha_string); 
  // Verifica o conteúdo da mensagem e aciona o LED de acordo
  if(minha_string == "diabo!")                // Se a mensagem for "on"
  {
    digitalWrite(2, 0); 
     MQTT.publish("escolha", "Diaboooo");              
  }
  else if(minha_string == "jesus!!")          // Se a mensagem for "off"
  {
    digitalWrite(2, 1);   
     MQTT.publish("escolha","Jesus");               
  }
}
